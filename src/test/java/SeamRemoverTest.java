...
class SeamRemoverTest
{
    ...
    void removeHorizontalSeam()
    {
        ...
        ArrayList<Integer> toRemove = new ArrayList<>(Arrays.asList(2, 1, 0, 1, 0));
        SeamRemover seamRemover = new SeamRemover();
        Pixel[][] calculatedEnding = seamRemover.removeHorizontal(image, toRemove);
        assertTrue(Arrays.deepEquals(ending, calculatedEnding));
    }
}